...
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"feedDB"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"sachinns"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"nexus"}
